...
## On-Demand Provisioning Test Process
...
## Use the Get-MgPolicyCrossTenantAccessPolicyPartner command
...
```
NumFromDate(Join("", FormatDateTime([ContractEndDate], "yyyy-MM-ddzzz"), " 23:59:59-08:00"))
```
